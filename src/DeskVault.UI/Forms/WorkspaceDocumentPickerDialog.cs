...
public partial class WorkspaceDocumentPickerDialog : Form
{
    private readonly IReadOnlyList<Document> _documents;
    private readonly HashSet<Guid> _workspaceDocumentIds;

    public WorkspaceDocumentPickerDialog(
        IReadOnlyList<Document> documents,
        IEnumerable<Guid> workspaceDocumentIds)
    {
        ArgumentNullException.ThrowIfNull(documents);
        ArgumentNullException.ThrowIfNull(workspaceDocumentIds);

        _documents = documents;
        _workspaceDocumentIds = workspaceDocumentIds.ToHashSet();
    ...
    private void LoadDocumentList()
    {
        ...
        IEnumerable<Document> availableDocuments =
