...
partial class WorkspaceDetailsDialog
{
    /// <summary>
    ...
    private void InitializeComponent()
    {
        ...
        workspaceNameLabel.Size = new Size(205, 32);
        ...
        saveButton.Location = new Point(888, 623);
        saveButton.Margin = new Padding(6, 6, 6, 6);
        saveButton.Name = "saveButton";
        saveButton.Size = new Size(167, 68);
        saveButton.TabIndex = 6;
        saveButton.Text = UiMessages.SaveButton;
        ...
        MaximizeBox = false;
        MinimizeBox = false;
        Name = "WorkspaceDetailsDialog";
        ShowInTaskbar = false;
        StartPosition = FormStartPosition.CenterParent;
        Text = UiMessages.UpdateWorkspaceDetailsTitle;
        ResumeLayout(false);
        PerformLayout();
    }
